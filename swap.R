...
mat <- data.table(
  "Val?r Tarihi" = rep(as.Date("2020-10-10"),length(sel)),
  "TCMB D?viz Karsiligi TL Swap Piyasasi" = rep(0,,length(sel)),
  "TCMB D?viz Karsiligi TL Swap Piyasasi - Stok"= rep(0,,length(sel)), 
  ...
  "TCMB D?viz Karsiligi TL Swap Geleneksel Ihaleleri" = rep(0,,length(sel)),
  "TCMB D?viz Karsiligi TL Swap Geleneksel Ihaleleri - Stok" = rep(0,,length(sel)),
  "TCMB D?viz Karsiligi TL Swap Miktar Ihaleleri" = rep(0,,length(sel)),
  "TCMB D?viz Karsiligi TL Swap Miktar Ihaleleri - Stok" = rep(0,,length(sel)),
  ...
  "TCMB D?viz Karsiligi Altin Swap Piyasasi (Net Alim)"= rep(0,,length(sel)),
  "TCMB D?viz Karsiligi Altin Swap Piyasasi - Stok (Net Alim)"= rep(0,,length(sel)),
